//
//  KhulnaSoftFileBackedQueueTest.swift
//  KhulnaSoftTests
//
...
class KhulnaSoftFileBackedQueueTest: QuickSpec {
    let eventJson =
        """
        {
          "properties": {
            ...
            "$device_name": "iPhone",
            "$app_name": "",
            "$app_namespace": "com.khulnasoft.CocoapodsExample",
            "$locale": "en-US",
    ...
    func getSut() -> KhulnaSoftFileBackedQueue {
        ...
        return KhulnaSoftFileBackedQueue(queue: newURL, oldQueue: oldURL)
    }
