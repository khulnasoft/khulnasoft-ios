...
class KhulnaSoftContextTest: QuickSpec {
    func getSut() -> KhulnaSoftContext {
        #if !os(watchOS)
            ...
            return KhulnaSoftContext(reachability)
        #else
            return KhulnaSoftContext()
        #endif
    }
    ...
    override func spec() {
        ...
        it("returns sdk info") {
            ...
            expect(context["$lib"] as? String) == "khulnasoft-ios"
            expect(context["$lib_version"] as? String) == khulnaSoftVersion
        }
    }
}
