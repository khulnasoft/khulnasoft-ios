//
//  KhulnaSoftPropertiesSanitizer.swift
//  KhulnaSoft
//
...
@objc(KhulnaSoftPropertiesSanitizer) public protocol KhulnaSoftPropertiesSanitizer {
    ...
    ///
    /// ```swift
    /// private class ExampleSanitizer: KhulnaSoftPropertiesSanitizer {
