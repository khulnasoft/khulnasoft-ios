...
public class KhulnaSoftEvent {
    ...
    static func fromJSON(_ data: Data) -> KhulnaSoftEvent? {
    ...
    static func fromJSON(_ json: [String: Any]) -> KhulnaSoftEvent? {
