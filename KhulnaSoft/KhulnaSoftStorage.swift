...
/**
 ...
 khulnasoft-ios stores data either to file or to UserDefaults in order to support tvOS. As recordings won't work on tvOS anyways and we have no tvOS users so far,
...
class KhulnaSoftStorage {
    // when adding or removing items here, make sure to update the reset method
    enum StorageKey: String {
        case distinctId = "khulnasoft.distinctId"
        case anonymousId = "khulnasoft.anonymousId"
        case queue = "khulnasoft.queueFolder" // NOTE: This is different to khulnasoft-ios v2
        case oldQeueue = "khulnasoft.queue.plist"
        case replayQeueue = "khulnasoft.replayFolder"
        case enabledFeatureFlags = "khulnasoft.enabledFeatureFlags"
        case enabledFeatureFlagPayloads = "khulnasoft.enabledFeatureFlagPayloads"
        case groups = "khulnasoft.groups"
        case registerProperties = "khulnasoft.registerProperties"
        case optOut = "khulnasoft.optOut"
        case sessionReplay = "khulnasoft.sessionReplay"
        case isIdentified = "khulnasoft.isIdentified"
        case personProcessingEnabled = "khulnasoft.enabledPersonProcessing"
    }
    ...
    /**
     There are cases where applications using khulnasoft-ios want to share analytics data between host app and
     ...
     */
    private static func getAppFolderUrl(from configuration: KhulnaSoftConfig) -> URL {
        /**
