//
//  KhulnaSoftStorageManager.swift
//  KhulnaSoft
//
...
// Internal class to manage the storage metadata of the KhulnaSoft SDK
public class KhulnaSoftStorageManager {
    ...
    init(_ config: KhulnaSoftConfig) {
        storage = KhulnaSoftStorage(config)
