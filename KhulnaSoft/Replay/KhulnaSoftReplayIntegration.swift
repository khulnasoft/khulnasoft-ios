...
//
//  KhulnaSoftReplayIntegration.swift
//  KhulnaSoft
//
...
//
    ...
    class KhulnaSoftReplayIntegration {
        ...
        static let dispatchQueue = DispatchQueue(label: "com.khulnasoft.KhulnaSoftReplayIntegration",
        ...
        private func isNotFlutter() -> Bool {
            khulnaSoftSdkName != "khulnasoft-flutter"
        }
        ...
        private func findMaskableWidgets(_ view: UIView, _ window: UIWindow, _ maskableWidgets: inout [CGRect], _ maskChildren: inout Bool) {
            ...
            // manually masked views through view modifier `KhulnaSoftMaskViewModifier`
            if view.khulnaSoftNoCapture {
                maskableWidgets.append(view.toAbsoluteRect(window))
                return
            }
