 ...
 */
    ...
    class URLSessionInterceptor {
        ...
        private let queue = DispatchQueue(label: "com.khulnasoft.URLSessionInterceptor", target: .global(qos: .utility))
        ...
        private func isCaptureNetworkEnabled() -> Bool {
            config.sessionReplayConfig.captureNetworkTelemetry && KhulnaSoftSDK.shared.isSessionReplayActive()
        }
